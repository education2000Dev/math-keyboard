    ...
    render() {
        return (
            <div className={(this.state.active?this.state.ClassName2:this.state.ClassName) + ' mathboard_'+this.props.value} onTouchStart={() => this.onTouchStart()} onTouchEnd={(e) => this.onTouchEnd(e)}>
                <SVGInline className='svg' svg={WordButtonSvg[this.props.value]} />
            </div>
        )
    }
}
        ...
        return (
            <div className='number-board-container'>
                ...
                <div className='number-board-row'>
                    ...
                    <WordButton value='backspace' handleExtraClick={this.handleExtraClick} />
                </div>
